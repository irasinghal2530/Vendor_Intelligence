...
#     """
#     Safely extract display text from LLM output.
#     Supports both strings and {key: value} dicts.
#     """
...
#     # ✅ HARD GUARD: chat requires analysis first
#     if not st.session_state.analysis:
#         st.warning(
#             "Please upload documents and click **Analyze** before using guided exploration."
#         )
#         st.stop()
